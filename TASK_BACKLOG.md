...
| T-005 | Make autonomous mode reliably execute continuous work during your offline window (queue → PRs → reports) | P3 | queued | M | this month | Ensure autonomous runner loops, produces PRs, stops on time, and always reports in human‑readable format | Done when autonomous runs generate PRs without prompts, stop at cutoff, and deliver readable summaries automatically |
